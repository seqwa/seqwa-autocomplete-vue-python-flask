<template>
  <div class="max-w-xl lg:max-w-5xl mx-auto px-4 py-[5vh]">
    <h1 class="text-5xl text-indigo-100 text-center mb-6">Autocomplete</h1>
    <Help></Help>
    <h2
      class="
        text-white
            ...
            <div class="relative mt-1">
              ...
              >
                <ComboboxInput
                  class="
                    w-full
                    border-none
                    focus:outline-none focus:ring-1 focus:ring-indigo-100
                    py-2
                    pl-3
                    pr-10
                    text-sm
              ...
              >
                ...
                >
                  ...
                  <ComboboxOption
                    v-for="(result, index) in searchResults.suggestions"
                    as="template"
                    :key="index"
                    :value="result"
...
const categories = ["Suggestions", "Records"];
let selected = ref();
</script>
